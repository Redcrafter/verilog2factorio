...
import { Color, Entity, makeConnection, each, signalC, signalGreen, signalGrey, signalV } from "../entities/Entity.js";
...
export class SHR extends Node {
    ...
    _connect(getInputNode: nodeFunc) {
        ...
        if (this.data.parameters.A_WIDTH == 32 && this.data.parameters.A_SIGNED == 0) {
            ...
            makeConnection(Color.Green, trans.output, calculator.input);
